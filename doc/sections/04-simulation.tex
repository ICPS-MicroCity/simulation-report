...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        ymajorgrids=true,
        yminorgrids=true,
        xlabel={Simulation steps}, ylabel={Waiting times variance}, title={},
        axis on top=true, clip=false,  width=\textwidth, height=.6\textwidth,
        legend style={
            at={(0,0)},
            anchor=north east,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Variance of the waiting times for the three different redirection policies.}
    \label{plot:var-waiting-times}
\end{figure}

As shown in the plot~\ref{plot:var-waiting-times}, the waiting times increase with the simulation steps. ...